return {
	...
	config = function()
		...
		keymap.set("n", "<leader>ds", dap.step_into, { desc = "Step Into" })
		...
		-- CLion 스타일 추가 키맵
		keymap.set("n", "<leader>3", dap.continue, { desc = "Debug: Start/Continue" })
		keymap.set("n", "<F7>", dap.step_into, { desc = "Debug: Step Into" })
		keymap.set("n", "<F8>", dap.step_over, { desc = "Debug: Step Over" })
		keymap.set("n", "<S-F8>", dap.step_out, { desc = "Debug: Step Out" })
